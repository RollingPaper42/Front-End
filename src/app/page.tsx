    ...
    <div className={`${theme.bgTheme.background}`}>
      ...
      <div className=" fixed flex h-full w-full max-w-md  flex-col">
        ...
        <div className="basis-6/12">
          <div
            className={`mx-[24px] mt-[25px] text-[20px] ${theme.textTheme.default}`}
          >
            <p>
          ...
          <div className=" flex h-full w-full flex-col">
            <div className="mx-[24px] mt-[100px] inline basis-1/2 text-[22px]">
              <div className="inline">
                <button
                  className={`relative h-[33px] w-[150px] items-center ${theme.bgTheme.leftCTA} text-[22px]`}
                  onClick={handlePersonalStrcat}
                >
                  <div
                    className={`relative bottom-[4.5px] left-[2px] h-[33px] w-[150px] text-[22px] ${theme.bgTheme.leftCTA}`}
                  >
            ...
            <div className="mx-[24px] inline basis-1/2 text-[22px]">
              <div className="inline">
                <button
                  className={`relative h-[33px] w-[200px] items-center ${theme.bgTheme.rightCTA} text-[22px]`}
                  onClick={handleGroupStrcat}
                >
                  <div
                    className={`relative bottom-[4.5px] left-[2px] h-[33px]  w-[200px] text-[22px] ${theme.bgTheme.rightCTA}`}
                  >
                    <div className="relative top-1 select-none">
                      그룹 스트링캣 만들기
                    </div>
              ...
              <div
                className={`inline text-[22px] ${theme.textTheme.explainRightCTA}`}
              >
