...
export default function Home() {
  ...
  return (
    <div className={`${Theme.BgColor} relative h-screen`}>
      <Image
        src="/strcatImage.png"
        width={153}
        height={1040}
      ...
      />
      <div
        className={`absolute left-6 top-72 -z-0 w-40 text-2xl ${Theme.DefaultFontColor} `}
      >
      ...
      <div className={`m-6 text-xl ${Theme.DefaultFontColor}`}>{Title}</div>
    </div>
  );
}
